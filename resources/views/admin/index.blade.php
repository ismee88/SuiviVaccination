                        ...
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <a href="#" class="count-title">Vaccin total</a>
                                    <a href="#" class="count"> {{App\Models\Vaccin::count()}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <a href="#" class="count-title">Personnel de Santé</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <a href="#" class="count-title">Patient</a>
                                    <a href="#" class="count"> 0</a>
                                </div>
                            </div>
                        </div>
